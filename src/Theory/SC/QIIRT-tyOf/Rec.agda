  ...
  where
    bar =
      π₁ᴹ (recSub σ) ,ᴹ π₂ᴹ (recSub σ) ∶[ tyOfπ₂ᴹ (recSub σ) ]
        ≡[ i ]⟨ (π₁ᴹ (recSub σ) ,ᴹ π₂ᴹ (recSub σ) ∶[ UIP (tyOfπ₂ᴹ (recSub σ)) (recTyOf (π₂ σ) (tyOfπ₂ σ)) i ]) ⟩
...
recTyOf {A = A} (βπ₂ σ t p₁ q i) = 
  ...
  (λ j → isPropΠ λ _ → UIP) (recTyOf (βπ₂ σ t p₁ q i0)) (recTyOf (βπ₂ σ t p₁ q i1)) i 
...
recTyOf {A = A} ([idS]t t i) =
  ...
  (λ j → isPropΠ λ _ → UIP) (recTyOf ([idS]t t i0)) (recTyOf ([idS]t t i1)) i 
...
recTyOf {A = A} ([∘]t t σ τ i) = 
  ...
  (λ j → isPropΠ λ _ → UIP) (recTyOf ([∘]t t σ τ i0)) (recTyOf ([∘]t t σ τ i1)) i 
