...
\begin{enumerate}
  ...
  \item \emph{locally confluent}, i.e.\ for any two function clauses $f\;\overrightarrow{p_1} \reduce t_1$ and $f\;\overrightarrow{p_2} \reduce t_2$ with a most general unifer $\sigma$ for $\overrightarrow{p_1}$ and $\overrightarrow{p_2}$, their right-hand sides $\sigma t_1$ and $\sigma t_2$ are strictly equal, 
\end{enumerate}
