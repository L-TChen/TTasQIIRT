...
\end{alignat*}
satisfying certain laws (introduced later as equality constructors).
...
With this definition of type substitution, other equality constructors can be introduced without any $\transp$, updated constructors are listed below.
\begin{alignat*}{5}
