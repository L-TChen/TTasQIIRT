...
The standard $\Set$-theoretic model for our definition, justifying its soundness, is given by the same motives as those for its QII counterpart~\cite[Section~4]{Altenkirch2016a}:
\begin{alignat*}{5}
