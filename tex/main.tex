...
\acknowledgements{We thank Hsiang-Shang Ko for useful discussions.}%optional
...
Thus, when a function $f$ is defined with overlapping patterns, the notation $f\;\overrightarrow{p_i} \reduce t_i$ is used to emphasise its reduction behaviour.
...
For our QIIRT definition, %$\sigma\uparrow A$ and $[]\lambda$ do not need a transport since $[;]_T$ and $[]\Pi$ are strict.
