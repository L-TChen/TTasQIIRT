...
\\
\>[8]{}\Varid{→}\;{}\<[11]%
\>[11]{}(\Varid{b}\;\mathbin{:}\;\Conid{Tm}\;(\Conid{Γ}\;\Varid{,}\;\Conid{El}\;\Varid{a}\;\Varid{pa}))\;{}\<[E]%
\\
\>[8]{}\Varid{→}\;{}\<[11]%
\>[11]{}\highlight{addition}{(\Varid{pb}\;\mathbin{:}\;\Varid{tyOf}\;\Varid{b}\;\mathop\equiv\;\Conid{U})}\;\Varid{→}\;\Conid{Tm}\;\Conid{Γ}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{π[]}\;{}\<[8]%
\>[8]{}\mathbin{:}\;{}\<[11]%
...
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{≡Sub[}\;\Varid{refl}\;\Varid{]⟨}\;\Varid{cong}\;{}\<[25]%
\>[25]{}(\Varid{λ}\;\Varid{z}\;\Varid{→}\;\Varid{...}\;\Varid{,}\;\Varid{...}\;\Varid{∶[}\;\Varid{refl}\;\Varid{,}\;\Varid{z}\;\kern-1.5pt]^{\bullet}_{\text{t}})\;{}\<[E]%
\\
\>[25]{}(\Conid{Ty∙-is-set}\;{}\<[38]%
\>[38]{}\anonymous \;\anonymous )\;\Varid{⟩}\;{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{π₁}^{\bullet}\;(\Varid{elimSub}\;\Varid{σ})\;\Varid{,}\;{}\<[E]%
\\
